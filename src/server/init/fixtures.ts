...
export default async function fixtures(db: Database) {
    ...
    await db.fixture(new Question("id1", "id1", "test", "TestQuestion", "A question used during testing", "test"), new Question("id2", "id1", "test", "TestQuestion", "A question used during testing", "test"));
